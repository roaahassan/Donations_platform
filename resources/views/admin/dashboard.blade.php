    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card text-white bg-primary mb-3">
                ...
                <div class="card-body">
                    <h5 class="card-title">عدد الحوجات: {{ $needsCount }}</h5>
                    <a href="{{ route('dashboard.needs') }}" class="btn btn-light">عرض الحوجات</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-success mb-3">
                ...
                <div class="card-body">
                    <h5 class="card-title">عدد التبرعات: {{ $donationsCount }}</h5>
                    <a href="{{ route('dashboard.donations') }}" class="btn btn-light">عرض التبرعات</a>
                </div>
            </div>
        </div>
